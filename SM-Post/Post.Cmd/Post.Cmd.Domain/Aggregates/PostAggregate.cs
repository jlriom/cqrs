...
public class PostAggregate: AggregateRoot
{
    ...
    public void EditMessage(string message)
    {
        if(!_active)
        {
            throw new InvalidOperationException("Yo cannot edit the message of an inactive post!");
        }
    ...
    public void AddComment(string comment, string username)
    {
        ...
        {
            throw new InvalidOperationException($"The value of {nameof(comment)} cannot be null or empty. Please providee a valid {nameof(comment)}");
        }
    ...
    public void DeletePost(string username)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to delete a post that was made by some else!");
        }
